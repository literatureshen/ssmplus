...
public class MpGenerator {
	...
	public void generateCode() {
		// 指定包名
		String packageName = "com.literature";
	...
	private PackageConfig getPackageConfig(String packageName) {
		return new PackageConfig().setParent(packageName).setXml("mapper").setMapper("mapper").setController("controller")
				.setEntity("entity");
	}
	...
	private GlobalConfig getGlobalConfig(boolean serviceNameStartWithI) {
		...
		globalConfig.setBaseColumnList(true).setBaseResultMap(true).setActiveRecord(false).setAuthor("Literature")
				// 设置输出路径
				.setOutputDir(getOutputDir("ssmplus")).setFileOverride(true);
